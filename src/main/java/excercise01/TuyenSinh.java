...
public class TuyenSinh implements ITuyenSinh {
    ...
    private List<ThiSinh> dsThiSinh = new LinkedList<>();
    ...
    public void showMenu() {
        while (true) {
            ...
            if (menu == 1) {
                ...
                return;
            } else System.out.println("Vui lòng nhập đúng chức năng");
        }
    ...
    public void hienThiDSTS() {
        System.out.println("+------+--------------------+--------------------+--------------------+------+");
        System.out.println("+ SBD  |       HO TEN       |         DIA CHI    |         MON THI    | MUT  |");
        System.out.println("+------+--------------------+--------------------+--------------------+------+");
        for (ThiSinh thiSinh : dsThiSinh) {
            System.out.printf("| %-4s | %-18s | %-18s | %-4s | %-18s |%n", thiSinh.soBaoDanh, thiSinh.hoTen, thiSinh.diaChi, thiSinh.mucUuTien, thiSinh.monThi());
            System.out.println("+------+--------------------+--------------------+--------------------+------+");
        }
    }
